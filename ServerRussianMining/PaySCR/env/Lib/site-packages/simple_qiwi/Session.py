...
from simple_qiwi import OverridingEx, InvalidTokenError, ArgumentError, QIWIAPIError, Webhook
import requests
import threading
import time
...
class QApi(object):
    ...
    def makerequest(self, url, params={}, method='GET'):
        return self._s.request(method, url, params=params)
    ...
    def start_webhook(self) -> bool:
        ...
        self.webhook = Webhook.Webhook(self._echo)
        self.webhook.register(self._s)
        return True
